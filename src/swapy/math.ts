...
export function lerpBorderRadius(b1: BorderRadius, b2: BorderRadius, t: number): BorderRadius {
	return {
		x: {
...
export function remap(a: number, b: number, c: number, d: number, value: number) {
