...
export function isBorderRadius(borderRadius: any): borderRadius is BorderRadius {
	return (
...
export function calculateBorderRadiusInverse({ x, y, unit }: BorderRadius, scaleX: number, scaleY: number): BorderRadius {
	if (unit === 'px') {
