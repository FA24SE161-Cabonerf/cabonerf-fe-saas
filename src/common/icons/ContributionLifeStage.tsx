...
export default function ContributionLifeStage({ one = 'currentColor', three = 'currentColor', two = 'currentColor' }: Props) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} color="currentColor" fill="none">
			...
			<path
				...
				strokeLinejoin="round"
			/>
			<path d="M4 2V22" stroke={three} fill={three} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
		</svg>
	);
}
