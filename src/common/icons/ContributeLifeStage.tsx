...
export default function ContributeLifeStage({ height, width }: Props) {
	return (
		<svg
			...
			fill={'currentColor'}
		>
			<path d="M9.713 7.97461C6.60492 7.97461 4.08533 10.2303 4.08533 13.0129H9.713V7.97461Z" stroke="currentColor" strokeWidth="1.5" />
			<path
