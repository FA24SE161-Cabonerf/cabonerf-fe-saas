...
export default function SuccessSooner({ message }: Props) {
	return (
		<div className="flex items-center space-x-3">
			{/* Icon */}
			<div className="h-fit w-[fit] rounded-xl bg-[#22c55e] p-1.5 shadow-lg shadow-[#dcfce7]">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} color={'#fff'} fill={'#fff'}>
					<path
