...
import { CreateElementaryExchange, CreateProductExchange, Unit } from '@/@types/exchange.type';
...
export class ExchangeApis {
	...
	public async createProductExchange(payload: CreateProductExchange) {
		return httpService.post<CommonResponse<CabonerfNodeData>>(EXCHANGE_ENDPOINT.EXCHANGE + EXCHANGE_ENDPOINT.PRODUCT_EXCHANGE, payload);
	}
